...
PROJECT_APPS = ["apps.auth_.apps.AuthConfig", "apps.scrape.apps.ScrapeConfig", "apps.email_sender.apps"
                                                                               ".EmailSenderConfig"]
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        default='postgresql://postgres:postgres@localhost:5432/scrapper',
        conn_max_age=600
    )
}
